...
class JConfig
{
	...
	public $sitename = 'Cassini-Test';            // Name of Joomla site
	...
	public $host = '10.65.20.216';              // This is normally set to localhost
	public $user = 'rayoss';                       // DB username
	public $password = 'webchica';                   // DB password
	public $db = 'firefly18_test';                         // DB database name
